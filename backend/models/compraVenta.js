...
const CompraVenta = db.define('CompraVenta', {
    id_compraventa: {
...
CompraVenta.belongsTo(EmpresaCuenta, { foreignKey: 'id_cuentaexenta', as: 'cuentaExenta' });
CompraVenta.belongsTo(EmpresaCuenta, { foreignKey: 'id_cuentagrav10', as: 'cuentaGrav10' });
CompraVenta.belongsTo(EmpresaCuenta, { foreignKey: 'id_cuentagrav05', as: 'cuentaGrav05' });
