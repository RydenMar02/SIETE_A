          ...
          <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200">
            <div class="overflow-x-auto">
              <table class="w-full text-sm">
                ...
                <tbody>
                  <tr v-for="item in itemsPaginados" :key="item.id_sucursal" class="border-b border-gray-100 odd:bg-white even:bg-slate-100 hover:bg-green-50 transition-colors">
...
useEspejoApp('/sucursal', snapshotEspejo)
